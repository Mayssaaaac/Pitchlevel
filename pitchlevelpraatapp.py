...
def average_score(audio_file_path, praat_script_content, path, score_index):
...
async def analyze_pitch_endpoint(file: UploadFile = File(...)):
    ...
    pronunciation_score = average_score(temp_file_path, praat_script_content, os.path.dirname(temp_file_path), 14)  
    articulation_score = average_score(temp_file_path, praat_script_content, os.path.dirname(temp_file_path), 3)   
    ...
    positive_criteria_count = (1 if pitch_result == "Balanced" else 0) + \
                              ...
                              (pronunciation_score * 1 if average_score else 0) + \
                              (1 if articulation_score >= 3 else 0)
...
async def analyze_video_pitch(file: UploadFile = File(...)):
    ...
    pronunciation_score = average_score(audio_file_path, praat_script_content, os.path.dirname(audio_file_path), 14)
    articulation_score = average_score(audio_file_path, praat_script_content, os.path.dirname(audio_file_path), 3)  
